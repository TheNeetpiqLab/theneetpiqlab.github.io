...
- [Virtualization Howto](https://www.virtualizationhowto.com/) - VirtualizationHowto is a site dedicated to providing you with [Brandon Lee](https://www.virtualizationhowto.com/author/brandon-lee/) expert insights, tools, and knowledge needed in today’s complex IT world, featuring insights into virtualization, cloud computing, containers & Kubernetes, and home lab learning.
...
- [Proxmox VE Helper-Scripts](https://community-scripts.github.io/ProxmoxVE/) (07/02/26) - Community-driven scripts for Proxmox VE — browse, install, and manage containers and VMs with a single command.
    - [Source code on GitHub](https://github.com/community-scripts/ProxmoxVE)

## Product Design

- [Resources - Pretotyping.org](https://www.pretotyping.org/resources.html)- Pretotyping is a set of tools, techniques, and tactics designed to help you validate any idea for a new product quickly, objectively, and accurately. The goal of pretotyping is to help you make sure that you are building [The Right It](https://www.amazon.it/Right-Many-Ideas-Yours-Succeed/dp/0062884654/) before you build It right.
- [Indie Hackers](https://www.indiehackers.com/) (04/02/26)

## Personal Brands

- [PersonalSit.es](https://personalsit.es/) (10/02/26) - This site was built to share and revel in each others’ personal sites, and is currently home to ~875 of them.
    - [Open-source](https://github.com/xdesro/personalsit.es)

## Inspirations

- [Fictional Brands Archive](https://fictionalbrandsarchive.com/) - *Fictional Brands Archive* is a collection of many fictional brands found in films, series and video games. It is structured according to the principles of brand design and aims to provide a comprehensive view of each fictional brand, framing them in their own fictional context and documenting their use and execution in the source work.

## Agents and Prompts

- [Vibe Coding Tools](https://www.indiehackers.com/vibe-coding-tools) by [Indie Hackers](https://www.indiehackers.com/) (04/02/26)
- [Everyday Prompts](https://github.com/jamesmcroft/everyday-prompts) - A library of copy-ready prompts for ChatGPT, Copilot, and similar tools. Every prompt lives in its own file, grouped into categorized folders so you can jump straight to what you need.
- [Skills - The Open Agent skills ecosystem](https://skills.sh/) - Skills are reusable capabilities for AI agents. Install them with a single command to enhance your agents with access to procedural knowledge.

## DotNet Stuff

- [ASP.NET Core Diagnostic Scenarios](https://github.com/davidfowl/AspNetCoreDiagnosticScenarios) by [David Fowler](https://github.com/davidfowl)
...
- [C# Digest](https://csharpdigest.net/) - A carefully curated weekly newsletter for .NET developers.
    - [Newsletters Archive](https://csharpdigest.net/newsletters)
