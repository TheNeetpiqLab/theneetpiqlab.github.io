...
Allora ho cercato altro e alla fine sono approdato su [Hugo](https://gohugo.io/), molto pratico da utilizzare, supporta pagine e post scritti in [markdown](https://it.wikipedia.org/wiki/Markdown), scritto in [Go](https://go.dev/) e molto veloce a generare il sito in locale per fare i test prima di pubblicare.
